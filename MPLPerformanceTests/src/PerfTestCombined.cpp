...
class PerfClientHandler : public FixedSizeMsgClientHander
{
public:
   PerfClientHandler(int msg_size) : FixedSizeMsgClientHander(msg_size)
   {
   }
   ...
   {
      return new PerfClientHandler(GetMessageSize());
   }
